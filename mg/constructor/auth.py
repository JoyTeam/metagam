    ...
    def ext_name_blacklist(self):
        ...
        if req.ok():
            ...
            if len(blacklist) > name_blacklist_limit:
                errors["blacklist"] = self._("List is too big. Maximal number of entries is %d.") %  name_blacklist_limit
            if len(errors) == 0:
        ...
        fields =[
            {"name": "blacklist", "label": self._("List of restricted character names, one per line"), "type": "textarea", "height": 350, "width": 300, "value": blacklist, "value": blacklist},
        ]
        self.call("admin.form", fields=fields)
