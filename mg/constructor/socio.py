...
class Socio(ConstructorModule):
    ...
    def button_editor(self, button):
        ...
        fields = [
            ...
            {"name": "condition", "label": self._("Condition (when to show the link)"), "value": self.call("script.unparse-expression", condition) if condition else None},
            {"name": "title", "label": self._("Link text"), "value": self.call("script.unparse-text", title)},
