...
class AdminInterface(Module):
    ...
    def form(self, url=None, fields=None, buttons=None, title=None):
        if url is None:
            req = self.req()
        ...
        self.call("admin.response_js", "js/admin-form.js", "Form", {"url": url, "fields": fields, "buttons": buttons, "title": title})
